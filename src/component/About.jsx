                ...
                <div className="col-12 col-md-6 about-left d-flex flex-column justify-content-center align-items-start">
                    <div className="about-content sm:p-5 m-5">
                        ...
                        <blockquote className="blockquote text-start mb-4">
                            उच्च गुणवत्ता उपचार: आमचे डॉक्टर मूळव्याध आणि संबंधित आरोग्य समस्यांवर अद्ययावत आणि प्रभावी उपचार पद्धती वापरतात. आम्ही रुग्णांच्या गरजा लक्षात घेऊन वैयक्तिकृत उपचार योजना तयार करतो.
                        </blockquote>
