...
import './about.css';
import aboutherorm from '../assets/aboutherorm.png';
            ...
            <div className="row g-0 ">
                ...
                <div className="col-12 col-md-6 about-left d-flex flex-column justify-content-center align-items-start">
                    <div className="about-content sm:p-5  m-5">
                        <blockquote className="blockquote mb-5 fw-bold" style={{ fontSize: '2rem' }}>About Us</blockquote>
                        ...
                        <div className="d-flex  align-items-center mt-5 gap-3">
                            <img
                                ...
                                className="rounded-circle me-3 cir"
                                style={{ width: '80px', height: '80px', objectFit: 'cover', backgroundColor: 'white' }}
                            />
                            <div>
